...
import ProfilLoginOut from './ProfilLoginOut'
...
export default async function Header() {
    ...
    const user = userData ? { ...userData._doc } : null
    return (
        <header>
            <nav className="z-10 w-full absolute shadow-sm">
                <Container>
                    <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
                        ...
                        <div className="relative z-20 w-full flex justify-between lg:w-max md:px-0">
                            <Link href="/" aria-label="logo" className="flex space-x-2 items-center">
                                <Image src={'/images/igocar.png'} alt='igocar logo' width={100} height={30}></Image>
                            </Link>
