...
export default function CarInfo({ params }) {
    const { carName, price, transmission, passengers, brand, feul, imageUrl, id } = carsData[params.carId]
    return (
        <div className='pt-32 pb-32'>
            <Container>
                <div className='max-w-2xl mx-auto'>
                    <div className="p-5 shadow-xl relative rounded-lg border border-slate-200">
                        <h1 className='text-xl font-semibold text-black text-center mb-10'>{carName}</h1>
                        <h2 className='font-semibold text-primary absolute top-5 right-5'>${price}/day</h2>
                        <div className="mb-10">
                        ...
                        <div className='flex flex-wrap gap-y-2 mb-2'>
                            ...
                            <div className='basis-1/4 flex justify-center px-1 flex items-center'>
                                ...
                                <span className='text-gray-600 dark:text-gray-300'>{passengers} Passengers</span>
                            </div>
                            <div className='basis-1/4 flex justify-center px-1 flex items-center'>
                                <span className='mr-2'>
                            ...
                            <div className='basis-1/4 flex justify-center px-1 flex items-center'>
                                ...
                                <span className='text-gray-600 dark:text-gray-300'>{feul}</span>
                            </div>
                        </div>
